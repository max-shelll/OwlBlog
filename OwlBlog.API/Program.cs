...
using OwlBlog.API.Contracts;
using OwlBlog.API.Contracts.Services;
using OwlBlog.API.Contracts.Services.IServices;
using OwlBlog.API.Data;
...
namespace OwlBlog.API
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                var filepath = Path.Combine(AppContext.BaseDirectory, "OwlBlog.API.xml");
